...
public class Testequestao4 {
    public static void main(String[] args) {
        Questao4 contact01 = new Questao4("Leonardo Da´Vinci", "996543798"); // Xico - corrigindo: por que ta em ingles?
        Questao4 contact02 = new Questao4("Rafael", "996879560");
        Questao4 contact03 = new Questao4("Donatelo", "996874690");

        System.out.println("contact01 = " + contact01.getNome() + ", Numero:" + contact01.getTelefone()); // Xico -
                                                                                                          // corrigindo:
                                                                                                          // por que nao
                                                                                                          // usa o
                                                                                                          // toString?
